...
# Compile C Files (Yahan fs.c add kiya hai)
...
# Link Everything (Yahan fs.o add kiya hai)
ld -m elf_i386 -T linker.ld -z noexecstack -o myos.bin boot.o display.o shell.o fs.o kernel.o
